...
{
    //[TestFlight takeOff:@"332b91c093838f584f48ec62158f1d0a_NzQ2OTEyMDEyLTAzLTI1IDAxOjE3OjI5LjEyNDQwNA"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MouseHouse" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MouseHouse.sqlite"];
